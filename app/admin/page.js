...
export default function AdminDashboard() {
   ...
   useEffect(() => {
      if (activeTab === "support" && session?.user?.role === 'admin') {
         fetchTickets();
      }
   }, [activeTab]);
         ...
         <header className="border-b border-border/60 bg-background/80 backdrop-blur-xl sticky top-0 z-30 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
               ...
               <div className="h-14 flex items-center justify-between">
                  ...
                  <button onClick={() => signOut()} className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-border/60 hover:bg-destructive/10 hover:text-destructive transition-all text-[10px] font-black uppercase tracking-widest">
                     <LogOut size={14} />
